...
#ifdef PLATFORM_WINDOWS
using CBaseEntity_EmitSoundFilter_t = void (*)(CBaseEntity*, StartSoundEventInfo_t*, const IRecipientFilter*, const char*, float, const Vector*);
#else
using CBaseEntity_EmitSoundFilter_t = StartSoundEventInfo_t (*)(CBaseEntity*, const IRecipientFilter*, const char*, float, const Vector*);
#endif
using CBaseEntity_StopSound_t                     = void (*)(CBaseEntity*, const char*);
using CBaseEntity_DispatchTraceAttack_t           = void (*)(CBaseEntity*, const CTakeDamageInfo*, CTakeDamageResult*);
...
#endif
#ifdef PLATFORM_WINDOWS
using UTIL_DispatchParticleEffectFilterPosition_t = void (*)(const char*, Vector*, Vector*, CBaseEntity*, bool, int, IRecipientFilter*, bool);
#else
using UTIL_DispatchParticleEffectFilterPosition_t = void (*)(const char*,
                                                             CBaseEntity*,
                                                             bool,
                                                             int,
                                                             IRecipientFilter*,
                                                             ...
                                                             float /*angle_z*/);
#endif
using UTIL_DispatchParticleEffectFilterAttachment_t = void (*)(const char*, uint32_t, CBaseEntity*, uint8_t, uint32_t, bool, int, IRecipientFilter*, bool);
...
using CEntityInstance_GetEntityIndex_t = int32_t (*)(CEntityInstance*);
#ifdef PLATFORM_WINDOWS
using CEntityInstance_GetRefEHandle_t = int64_t (*)(CEntityInstance*, uint32_t* out);
#else
using CEntityInstance_GetRefEHandle_t = uint32_t (*)(CEntityInstance*);
#endif
...
#else
using CEntityInstance_GetOrCreatePrivateScriptScope_t = void (*)(CEntityInstance*);
#endif
...
#ifdef PLATFORM_WINDOWS
using StudioModel_LookupAttachment_t = void* (*)(void*, uint8_t*, const char*);
#else
