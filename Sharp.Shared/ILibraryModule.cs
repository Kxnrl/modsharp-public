...
public interface ILibraryModule
{
    ...
    /// <summary>
    ///     Find address of the given string in the module's data section.
    ///     An exact match ensures the string is not a partial substring of another string by verifying it is located at the
    ///     start of the data or immediately preceded by a null terminator.
