...
public interface IInputListenerRegistry
{
    ...
    /// <param name="holdDuration">Hold duration in seconds, only valid for KeyHold state. This means that how long the key must be held down before the action is triggered.</param>
